...
| :---------: | :----------------------------------------------: | :-----------------------------------: |
|    Icon     | Useful for favicons, app icons, link icons, etc. |      ![Rexplore icon](../icon.png)     |
|    Logo     |                 Full Rexplore logo               |       ![Rexplore logo](/logo.svg)      |
| Social Card |              The Rexplore social card            | ![Rexplore card](/opengraph-image.jpeg) |
